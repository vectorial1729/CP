...
#ifndef VECTORIAL_MULTIPLE_TRANSFORM
#define VECTORIAL_MULTIPLE_TRANSFORM

#include <vector>
#ifndef VECTORIAL_DEFAULT_OPERATOR
#define VECTORIAL_DEFAULT_OPERATOR
...
namespace vectorial::multiple_transform {
